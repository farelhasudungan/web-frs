...
@section('title', 'Manage Courses - Course System')

@section('content')
<!-- Manage Courses UI — consistent with other pages (Poppins, blue bg, wheels, waves, bold headings) -->
<style>
    ...
    .table-responsive {
        border-radius: 10px;
        overflow: hidden;
        outline: 4px solid rgba(0,0,0,0.9); /* strong dark outline for contrast */
    ...
    .table tbody td { vertical-align: middle; color: #06325a; }
...
<div class="page-wrap container">
    <div class="page-header">
        <div>
            ...
            <small class="muted-small d-block">Add, edit, or remove courses. Use actions to view details or manage students.</small>
        </div>

        <div class="d-flex align-items-center gap-2">
            <a href="{{ route('courses.create') }}" class="btn-wave" data-wave>
                ...
                <table class="table table-striped mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('courses.show', $course) }}" class="btn-outline btn-sm me-1" role="button" data-wave>
                                    <i class="fas fa-eye"></i>
                                </a>

                                <a href="{{ route('courses.edit', $course) }}" class="btn-outline btn-sm me-1" role="button" data-wave>
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('courses.destroy', $course) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this course? This action cannot be undone.');">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn-wave btn-sm" style="background: linear-gradient(90deg,#e74c3c,#ff6b6b);" data-wave>
